  ...
  const lawyers = [
    {
      ...
      image: '/images/avatars/lawyer1.jpg',
    },
    {
      name: 'Sarah Johnson',
      ...
      image: '/images/avatars/lawyer2.jpg',
    },
      ...
      >
        <Container maxWidth="lg">
          ...
          >
            ...
            >
              Connect with experienced legal professionals who specialize in your specific needs
            </Typography>
          </motion.div>
                  ...
                  <CardContent sx={{ p: 4 }}>
                    ...
                    <Stack spacing={2} sx={{ mb: 3 }}>
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <Typography variant="body2">{lawyer.experience} experience</Typography>
                      </Box>
                      <Box sx={{ display: 'flex', alignItems: 'center' }}>
