...
const features = [
  ...
  },
  {
    ...
    description:
      "Communicate with your lawyer through our encrypted messaging system.",
  },
  {
    icon: <Speed sx={{ fontSize: 40 }} />,
    title: "Quick Case Updates",
    description:
      "Stay informed about your case progress with real-time updates.",
  },
];
          ...
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              >
                ...
                >
                  LexConnect brings together clients and lawyers in a secure,
                  efficient platform designed to simplify your legal journey.
                </Typography>
                <Stack
                    ...
                    <Button
                      ...
                      sx={{
                        ...
                        "&:hover": {
                          ...
                          boxShadow:
                            "0 10px 15px -3px rgba(59, 130, 246, 0.4), 0 4px 6px -4px rgba(59, 130, 246, 0.4)",
                        },
                      }}
                    >
                      Get Started
              ...
              {[
                {
                  ...
                  description:
                    "Share your legal situation and requirements. Our platform ensures your privacy while connecting you with the right legal professionals.",
                  color: "#3B82F6",
                },
                {
                  ...
                  description:
                    "Get matched with experienced lawyers who specialize in your type of case. Choose between pro bono services or paid consultations.",
                  color: "#8B5CF6",
                },
                {
                  ...
                  description:
                    "Communicate securely through our platform, receive legal advice, and work with your chosen lawyer to resolve your case effectively.",
                  color: "#EC4899",
                },
                {
                  ...
                  description:
                    "Upload your legal documents and our AI-powered system will analyze and explain them in simple, easy-to-understand terms.",
                  color: "#10B981",
                },
              ].map((step, index) => (
                    ...
                    <Box
                      sx={{
                        ...
                        background: `linear-gradient(135deg, ${
                          step.color
                        } 0%, ${lightenColor(step.color, 20)} 100%)`,
                        color: "white",
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 8, md: 12 } }}>
        <Fade in timeout={1500}>
          <Box>
            ...
            >
              Our platform is designed to make legal services more accessible
            ...
            <Grid container spacing={4}>
              {[
                ...
                },
                {
                  ...
                  title: "Secure Communication",
                  description:
                    "Exchange messages and documents with lawyers through our encrypted platform, ensuring your sensitive information stays confidential.",
                  color: "#10B981",
                },
              ].map((feature, index) => (
                <Grid item xs={12} sm={6} md={3} key={index}>
                  ...
                  >
                    <Box
                      sx={{
                        ...
                        background: `linear-gradient(135deg, ${
                          feature.color
                        } 0%, ${lightenColor(feature.color, 20)} 100%)`,
                        color: "white",
